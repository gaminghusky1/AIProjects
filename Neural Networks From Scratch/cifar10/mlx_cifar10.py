...
def main():
    ...
    cifar_model.fit(x_train, y_train_oh, epochs=200, learning_rate=0.001, lr_function=warmup_cosine_lr, augmentation_function=cifar_augmentation_chw_mx, batch_size=64, verbose=2, previously_trained_epochs=50, save_after_num_epochs=10, model_save_path="Models/cifar_conv", save_metrics=True)
